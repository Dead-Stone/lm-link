...
/**
 * Brand SVGs not in current simple-icons — sourced from simple-icons v11 (Microsoft, IBM, OpenAI).
 * Bundled for offline use; see scripts/sync-brand-logos.mjs.
 */
export const CUSTOM_BRAND_LOGOS: Partial<Record<ModelBrandKey, BundledBrandLogo>> = {
  microsoft: {
    hex: "5E5E5E",
